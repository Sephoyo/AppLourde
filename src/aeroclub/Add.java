...
public class Add extends javax.swing.JFrame {
    ...
    public Add(int Viewer) {
        ...
        dateBBml.setVisible(false);
        dateBBmt.setVisible(false);
        numBBml.setVisible(false);
        numBBmt.setVisible(false);
        datePPLAml.setVisible(false);
        datePPLAmt.setVisible(false);
        numPPLAml.setVisible(false);
        numPPLAmt.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        BBCheckj = new javax.swing.JCheckBox();
        PPLACheck = new javax.swing.JCheckBox();
        ...
        BBCheckj.setText("BB");
        BBCheckj.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BBCheckjActionPerformed(evt);
            }
        });

        PPLACheck.setText("PPLA");
        PPLACheck.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                PPLACheckActionPerformed(evt);
            }
        });
            ...
            .addGroup(MembreDetLayout.createSequentialGroup()
                ...
                .addGroup(MembreDetLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(MembreDetLayout.createSequentialGroup()
                        .addGroup(MembreDetLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, MembreDetLayout.createSequentialGroup()
                                .addComponent(PPLACheck)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(pplathl)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(pplatht))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, MembreDetLayout.createSequentialGroup()
                                .addComponent(BBCheckj)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(bbmthl)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        memT.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                memTActionPerformed(evt);
            }
        });
    ...
    private void AddMemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddMemActionPerformed
        //Ajout d'un membre
        if (MemEmpty()) {
            System.out.println("J'ajoute mon membre");
            ...
            boolean rep = mem.AddMembre(selectedString, nomt.getText(), prenomt.getText(),
            ...
            if (rep) {
                ...
                JOptionPane.showMessageDialog(null, "Problème d'ajouts vérifier vos informations " + nomt.getText() + " " + prenomt.getText(), "Information !", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void AddSeqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddSeqActionPerformed
        ...
        if (SeqVolEmpty()) {
            ...
            boolean rep = true;
            if (fit.isSelected()) {
                rep = seq.AddSequenceVol(iId, mId, aId,
            ...
            if (rep) {
                System.out.println("Ajouts réussi de la sequence de vol : " + typet.getText() + " " + immt.getText());
                JOptionPane.showMessageDialog(null, "Ajouts réussi de la sequence de vol : " + typet.getText() + " " + immt.getText(), "Information !", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else if (!rep) {
                System.out.println("Problème d'ajouts");
            }
    ...
    private void AddAvActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddAvActionPerformed
        //Ajout d'un avion
        if (AvionEmpty()) {
            System.out.println("J'ajoute mon Instructeur");
            //Appelle la fonction pour créer un avion
            boolean rep = av.AddAvion(typet.getText(),
                    ...
                    immt.getText());
            if (rep) {
                System.out.println("Ajouts réussi de l'avion : " + typet.getText() + " " + immt.getText());
                JOptionPane.showMessageDialog(null, "Ajouts réussi du membre : " + typet.getText() + " " + immt.getText(), "Information !", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else if (!rep) {
                System.out.println("Problème d'ajouts");
            }
    ...
    private void BBCheckjActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBCheckjActionPerformed
        // TODO add your handling code here:
        if (BBCheckj.isSelected()) {
            bbmthl.setVisible(false);
            bbmtht.setVisible(false);
            dateBBml.setVisible(true);
            dateBBmt.setVisible(true);
            numBBml.setVisible(true);
            numBBmt.setVisible(true);
        } else {
            bbmthl.setVisible(true);
            bbmtht.setVisible(true);
            dateBBml.setVisible(false);
            dateBBmt.setVisible(false);
            numBBml.setVisible(false);
            numBBmt.setVisible(false);
        }
    }//GEN-LAST:event_BBCheckjActionPerformed

    private void PPLACheckActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PPLACheckActionPerformed
        // TODO add your handling code here:
        if (PPLACheck.isSelected()) {
            pplathl.setVisible(false);
            pplatht.setVisible(false);
            datePPLAml.setVisible(true);
            datePPLAmt.setVisible(true);
            numPPLAml.setVisible(true);
            numPPLAmt.setVisible(true);
        } else {
            pplathl.setVisible(true);
            pplatht.setVisible(true);
            datePPLAml.setVisible(false);
            datePPLAmt.setVisible(false);
            numPPLAml.setVisible(false);
            numPPLAmt.setVisible(false);
        }
    }//GEN-LAST:event_PPLACheckActionPerformed
    ...
    private void AddInstruActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddInstruActionPerformed
        if (InstruEmpty()) {
            ...
            String selectedString = selectedObject.toString();
            boolean rep = instru.AddInstructeur(selectedString, nomit.getText(),
            ...
            if (rep) {
                System.out.println("Ajouts réussi de l'isntructeur : " + nomit.getText() + " " + prenomit.getText());
                JOptionPane.showMessageDialog(null, "Ajouts réussi du membre : " + nomit.getText() + " " + prenomit.getText(), "Information !", JOptionPane.INFORMATION_MESSAGE);
                this.dispose();
            } else if (!rep) {
                System.out.println("Problème d'ajouts");
            }
    ...
    private void memTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_memTActionPerformed
        // TODO add your handling code here:
        //récupération de l'id du membre
        Object selectedObject = memT.getSelectedItem();
        String selectedString = selectedObject.toString();
        String[] membre = selectedString.split(" ");
        String mId = mem.getMemIdByNP(membre[0], membre[1]);
        //Récupére le type de l'avion
        if(avT.getSelectedItem() == null){
            
        }else{
        String type = avT.getSelectedItem().toString();
        //Récupère l'ilmatriculation
        String imm = av.getAvImmByType(type);
        //Récupère le forfait de l'id du membre avec l'immatricualtion de l'avion
        String forfait = co.getForfaitByImmId(imm, Integer.parseInt(mId));
        hft.setText(forfait);}
    }//GEN-LAST:event_memTActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Add(Viewer).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JCheckBox BBCheckj;
    ...
    private javax.swing.JCheckBox PPLACheck;
